...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\student\\Desktop\\dhruvi Lab in psy\\Tutorial 5_lastrun.py',
...
slider = visual.Slider(win=win, name='slider',
    ...
    labels=["Familar","Unfamilar"], ticks=(1, 2, 3, 4, 5), granularity=0.0,
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/student/Desktop/dhruvi Lab in psy/study_words.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/student/Desktop/dhruvi Lab in psy/test_words.xlsx'),
